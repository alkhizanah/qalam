...
on_resize :: proc "c" (window : glfw.WindowHandle, new_width, new_height : c.int) {
...
create_window :: proc(title : cstring, desired_width, desired_height : c.int) {
    ...
    window = glfw.CreateWindow(desired_width, desired_height, title, nil, nil)
    ...
    glfw.SetFramebufferSizeCallback(window, on_resize)
